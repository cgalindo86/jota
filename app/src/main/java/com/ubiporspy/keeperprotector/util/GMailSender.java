...
public class GMailSender extends javax.mail.Authenticator {
    ...
    synchronized void sendMail(String subject, String body, String sender, String recipients, File file) throws Exception {
        try {
            ...
            if (file != null) {
                ...
                bodyPart.setText("Registro de llamada");
                ...
                attachmentBp.setFileName(file.getName());
